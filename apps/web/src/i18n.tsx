...
const translations = {
  ...
  zh: {
    ...
    health: "健康状态", topicsLabel: "主题", connectors: "连接器", languageSetting: "界面语言", theme: "外观主题", themeHint: "选择适合你的工作区视觉风格。", themeDefault: "默认主题", themeDefaultHint: "沉静的仓库绿", themeMidnight: "午夜", themeMidnightHint: "专注的深色工作区", themeOcean: "海洋", themeOceanHint: "清爽的蓝色界面", themeSunset: "日落", themeSunsetHint: "温暖的琥珀色能量", themeForest: "森林", themeForestHint: "深沉的自然专注感", themeLavender: "薰衣草", themeLavenderHint: "柔和的创意氛围", themeGraphite: "石墨", themeGraphiteHint: "中性的深色精确感", themeRose: "玫瑰", themeRoseHint: "温暖的编辑感腮红", themeTerminal: "终端", themeTerminalHint: "高对比的绿色荧光", themeSand: "砂纸", themeSandHint: "安静的纸张工作区", themeCobalt: "钴蓝", themeCobaltHint: "电光蓝的专注感", themePlum: "梅紫", themePlumHint: "浓郁的夜间编辑感", themeMint: "薄荷", themeMintHint: "清新的轻盈明亮感", themeCopper: "铜色", themeCopperHint: "手作感的温暖对比", themeMono: "黑白", themeMonoHint: "安静的黑白工作区", themeAbyss: "深渊", themeAbyssHint: "深蓝黑的专注感", themeEmber: "余烬", themeEmberHint: "温暖的火光工作区", themeAurora: "极光", themeAuroraHint: "暗夜中的青绿色光", themeViolet: "紫夜", themeVioletHint: "深色的创意夜景", themeNavy: "海军蓝", themeNavyHint: "清晰的午夜蓝", themeCrimson: "绯红", themeCrimsonHint: "醒目的深红专注感", themeSapphire: "蓝宝石", themeSapphireHint: "深邃的蓝色清晰感", themeMoss: "苔藓", themeMossHint: "沉稳的绿色阴影", themeSolar: "日冕", themeSolarHint: "暗夜中的金色光线", themeInk: "墨色", themeInkHint: "极简的编辑黑",
